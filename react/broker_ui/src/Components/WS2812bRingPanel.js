...
export default function WS2812bRingPanel(props) {
    ...
    let handleClick = async () => {
      let res = await axios.put('https://broker.jack-gooding.com/ring/warm', {data: "test"});
      console.log(res);
    }
    ...
    return (
      <div className="WS2812bPanel panel-card anything">
        <div>
        ...
        <div>
          <div className="modes">
            ...
            <button onClick={() => {handleClick()}}>Rainbow</button>
          ...
          <div className="sliders">
            ...
            <Slider min="0" max="65534" item="bri" defaultValue={100} handleChange={e => updateLightState(e, "hue")} handleMouseUp={(e) => changeLightColor(e, "hue")}/>
          </div>
        </div>
      </div>
    );
